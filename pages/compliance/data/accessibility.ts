...
export const accessibilityData = {
  ...
  introduction: {
    ...
    content: [
      "Jetson Recruit AI is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.",
  ...
  sections: [
    ...
    },
    {
      ...
      title: "CONTACT US",
      content: "If you have any questions, concerns, or feedback about the accessibility of our services, please contact our accessibility team at accessibility@jetsonrecruit.com"
    }
  ]
};